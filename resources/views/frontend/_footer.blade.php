    ...
    >
      <div class="row pt-5">
        <div class="col-lg-3 col-md-6 mb-5">
          ...
          >
            ...
            <span class="text-white">College Name</span>
          </a>
          <p>
        ...
        <div class="col-lg-3 col-md-6 mb-5">
          ...
          <div class="d-flex flex-column justify-content-start">
            ...
            >
            <a class="text-white mb-2" href="{{ route('aboutCollege') }}"
      ...
      >
        <p class="m-0 text-center text-white">
          &copy;
          <a class=" font-weight-bold" href="#" style="color: white";>Your Site Name</a>.
          All Rights Reserved.

          <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
          Designed by
          <a style="color: white";class=" font-weight-bold" href="https://htmlcodex.com"
            >N-Web Development</a
          >
...
<script src="https://cdn.jsdelivr.net/npm/@coreui/coreui@5.3.1/dist/js/coreui.min.js" integrity="sha384-Rj9po7KQz8y0hVoeRgl1LRoQcxYkHxszkpKUdatY+9b5o35FsiENOwOWwxzWfAfF" crossorigin="anonymous"></script>
    ...
    <script src="{{ url('js/lightboxed.js') }}"></script>
    <script>
