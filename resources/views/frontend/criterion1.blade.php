...
<div class="container-fluid shadow mb-5" id="Nbackgroud">
    ...
    >
      <h3 class="display-3 font-weight-bold text-white">Criterion 1</h3>
      <div class="d-inline-flex text-white">
        <p class="m-0">NAAC</a></p>
        <p class="m-0 px-2">/</p>
        <p class="m-0">Criterion 1</p>
      </div>
    </div>
  </div>
  <!-- Header End -->
      ...
      <div class="col-10">
        <div class="text-center pb-2">
            <p class="section-title px-5">
              <span class="px-2"><span class="line-2"></span>Criterion 1 <span class="line-3"></span></span>
            </p>
