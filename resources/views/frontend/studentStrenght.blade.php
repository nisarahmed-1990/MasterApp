...
<div class="container-fluid shadow mb-5" id="Nbackgroud">
    ...
    >
      <h3 class="display-3 font-weight-bold text-white">Student Strenght</h3>
      <div class="d-inline-flex text-white">
        <p class="m-0">Admission</a></p>
        <p class="m-0 px-2">/</p>
        <p class="m-0">Student Strenght</p>
      </div>
    </div>
  </div>
  <!-- Header End -->
      ...
      <div class="col-10">
        <div class="text-center pb-2">
            <p class="section-title px-5">
              <span class="px-2"><span class="line-2"></span>Student Strenght<span class="line-3"></span></span>
            </p>
          </div>
