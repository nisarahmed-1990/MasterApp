...
<div class="pagetitle">
 ...
 <div class="card">
    <div class="card-body">
      ...
      <h5 class="card-title">Anit Ragging Committee
        <a href="{{ route('arc_insert') }}" class="btn btn-primary sm-btn" style="float: right">Add</a>
      </h5>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-secondary btn-sm" href="{{ url('arc_edit/'.$pdf->id) }}"><i class="bi bi-pencil"></i></a>
                    <a onclick="return confirm('Do you want to delete?')" class="btn btn-danger btn-sm" href="{{ url('arc_delete/'.$pdf->id) }}"><i class="bi bi-trash3-fill"></i></a>
                </td>
