    ...
    <div class="card">
        <div class="card-body">
          <h5 class="card-title">Books Collection
            <a href="{{ route('bookCollection_list') }}" class="btn btn-danger btn-sm" style="float: right"><i class="bi bi-arrow-left"></i>Back</a>
          </h5>
          ...
          <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-12">
                <label for="inputNanme4" class="form-label card-title">No.'s of Books Available</label>
                <input type="text" class="form-control" id="inputNanme4" name='nobooks' value="{{ $getRecord->nobooks }}">
              </div>
            {{-- <div class="col-12">
