        ...
        <div class="card-body">
          ...
          <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-12">
                ...
                <input type="text" class="form-control" id="inputNanme4" name='qualification' value="{{ $getRecord->qualification }}">
            </div>
            <div class="col-12">
            ...
            <div class="col-12">
                <label for="inputNanme4" class="form-label card-title">Department</label>
                <input type="text" class="form-control" id="inputNanme4" name='department' value="{{ $getRecord->department }}">
            </div>
            <div class="col-12">
            ...
            <div class="col-12">
                <label for="inputEmail4" class="form-label card-title">Profile</label>
                <input type="file" class="form-control" name='profile' id="inputEmail4">
