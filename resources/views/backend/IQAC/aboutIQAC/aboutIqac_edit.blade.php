...
<div class="pagetitle">
    <div class="card">
        <div class="card-body">
          <h5 class="card-title">Edit About IQAC
          ...
          <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-12">
                ...
                <input type="text" class="form-control" id="inputNanme4" name='iqacestb' value="{{ $getRecord->iqacestb }}">
            </div>

            <div class="col-12">
                <label for="inputNanme4" class="form-label card-title">IQAC Coordinator</label>
                <input type="text" class="form-control" id="inputNanme4" name='iqacco' value="{{ $getRecord->iqacco }}">
            </div>
