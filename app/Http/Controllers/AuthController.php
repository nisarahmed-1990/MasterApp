...
class AuthController extends Controller
{
    ...
    public function forgot_password(Request $request){
        ...
        if(!empty($user))
        {
                ...
                return redirect()->back()->with('success','Reset password link sent to registered mail');
        }
        else
        {
            return redirect()->back()->with('error','email not found, please check the email');
        }
    ...
    public function create_user(Request $request)
    {
        ...
        return redirect('login')->with('success', 'User Registered successfully & verify your email.');
    }
